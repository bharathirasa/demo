...
-- use the below code to create country table
CREATE TABLE countries (
id int(11) NOT NULL ,
country_code varchar2(2) NOT NULL default '',
country_name varchar2(100) NOT NULL default '',
PRIMARY KEY (id)
) ;
-- code to insert the country details
--just copy and paste all the code in Oracle Editor and run
